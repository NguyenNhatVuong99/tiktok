export const LocationArrowIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const TiktokIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const UsersIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const CameraIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export const ReturnIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor">
...
export const SongIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
        fill="rgba(22, 24, 35, 1)"
        styleType="0"
        className="tiktok-zq14c6-StyledIcon epjbyn4"
    >
        <use xlinkHref="#Music_Note-8c658968"></use>
    </svg>
);
export const UpToLineIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg width={width} data-e2e="" height={height} viewBox="0 0 48 48" fill="#FFF" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const PlusIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
